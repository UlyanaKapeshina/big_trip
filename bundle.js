...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/light.css":
/*!********************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/light.css ***!
  \********************************************************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../css-loader/dist/cjs.js!./flatpickr.min.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/flatpickr.min.css");
...
var content = __webpack_require__(/*! !../../../css-loader/dist/cjs.js!./light.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/themes/light.css");
...
/* harmony import */ var _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/model-event.js */ "./src/models/model-event.js");
/* harmony import */ var _models_model_destinations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/model-destinations */ "./src/models/model-destinations.js");
...
class API {
  ...
  getOffers() {
    ...
    .then(_models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseOffers);
  }
  getDestinations() {
    return this._load({
    ...
    .then((response) => response.json())
    .then(_models_model_destinations__WEBPACK_IMPORTED_MODULE_1__["default"].parseDestinations);
  }
  getEvents() {
    return this._load({
    ...
    .then((response) => response.json())
    .then(_models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents);

  }
  createEvent(event) {
    const dataRAW = _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(event);
    return this._load({
      url: `${this._url}points`,
      method: `POST`,
    ...
    .then((response) => response.json())
    .then(_models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvent);
  }
  deleteEvent(id) {
    return this._load({
  ...
  changeEvent(id, data) {
    const dataRAW = _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(data);
...
class Day extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    <div class="day__info">
      ...
      <time class="day__date" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format()}">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(`MMM DD`)}</time>
    </div>
...
class DaysList extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! flatpickr/dist/themes/light.css */ "./node_modules/flatpickr/dist/themes/light.css");
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_6__);
...
class EventEdit extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor({
    type,
    destination,
    price,
    ...
    this._type = {
      id: type,
      title: _util_js__WEBPACK_IMPORTED_MODULE_0__["TYPES_OF_EVENT"].find((it) => it.id === type).title
    };
  ...
  addFlatpickr() {
    const start = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()((this.getElement().querySelector(`#event-start-time-1`)), {
    ...
    const end = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()((this.getElement().querySelector(`#event-end-time-1`)), {
      dateFormat: `d.m.y H:i`,
      allowInput: true,
      enableTime: true,
    ...
    <form class="event  event--edit"  method="post" action="https://echo.htmlacademy.ru" enctype="multipart/form-data" autocomplete="off">
      <header class="event__header">
        <div class="event__type-wrapper">
          ...
          ${_util_js__WEBPACK_IMPORTED_MODULE_0__["TYPES_OF_TRANSFER"].map((transferType, index) => `<div class="event__type-item">
        ...
        <fieldset class="event__type-group">
          ...
          ${_util_js__WEBPACK_IMPORTED_MODULE_0__["TYPES_OF_ACTIVITY"].map((activityType) => `<div class="event__type-item">
        ...
        <datalist id="destination-list-1">
          ${_main_js__WEBPACK_IMPORTED_MODULE_1__["allDestinations"] ? _main_js__WEBPACK_IMPORTED_MODULE_1__["allDestinations"].map((destination) => `<option value="${destination.city}"></option>`).join(``) : ``}
        </datalist>
      </div>
      ...
      <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${moment__WEBPACK_IMPORTED_MODULE_3___default()(this._start).format(`D.MM.YY h:mm`)}" required readonly>
      &mdash;
      <label class="visually-hidden" for="event-end-time-1">
        To
      </label>
      <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${moment__WEBPACK_IMPORTED_MODULE_3___default()(this._end).format(`D.MM.YY h:mm`)}" required readonly>
    </div>
  ...
  _subscribeOnTypeChange() {
    ...
    const onTypeChange = (evt) => {
      const newType = _util_js__WEBPACK_IMPORTED_MODULE_0__["TYPES_OF_EVENT"].find((it) => it.id === evt.target.value);
      label.textContent = newType.title;
      img.src = `img/icons/${newType.id}.png`;
      const offers = _main_js__WEBPACK_IMPORTED_MODULE_1__["allOffers"].find((it) => it.type === newType.id).offers;
      if (!offersContainer) {
  ...
  _subscribeOnCityChange() {
    ...
    const onCityChange = (evt) => {
      ...
      if (options.find((it) => it.value === evt.target.value)) {
        const newDestination = _main_js__WEBPACK_IMPORTED_MODULE_1__["allDestinations"].find((it) => it.city === evt.target.value);
...
class Event extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({
    ...
    this._type = {
      id: type,
      title: _util_js__WEBPACK_IMPORTED_MODULE_3__["TYPES_OF_EVENT"].find((it) => it.id === type).title
    };
  ...
  _getDuration(startTime, endTime) {
    const start = moment__WEBPACK_IMPORTED_MODULE_1___default()(startTime);
    const end = moment__WEBPACK_IMPORTED_MODULE_1___default()(endTime);
    const difference = end.diff(start);
    return moment__WEBPACK_IMPORTED_MODULE_1___default.a.duration(difference, `milliseconds`).format(`dd[d] hh[h] mm[m]`);
  }
  ...
  getTemplate() {
    ...
    <div class="event">
      ...
      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._start).format()}">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._start).format(`h:mm`)}</time>
          &mdash;
          <time class="event__end-time" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._end).format()}">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._end).format(`h:mm`)}</time>
        </p>
...
/***/ "./src/components/loading-message.js":
/*!*******************************************!*\
  !*** ./src/components/loading-message.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LoadingMessage; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");

class LoadingMessage extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Message extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SortContainer; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");

class SortContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Stats extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getStatistics(eventsData) {
    ...
    chart_js__WEBPACK_IMPORTED_MODULE_1___default.a.defaults.global.defaultFontColor = `black`;
    chart_js__WEBPACK_IMPORTED_MODULE_1___default.a.defaults.global.defaultFontFamily = `"Montserrat", "Arial", sans-serif`;
    chart_js__WEBPACK_IMPORTED_MODULE_1___default.a.defaults.global.defaultFontSize = 14;

    this._moneyChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(moneyCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
      type: `horizontalBar`,
      data: {
        labels: types,
        datasets: [{
    ...
    const transfers = _util_js__WEBPACK_IMPORTED_MODULE_3__["TYPES_OF_TRANSFER"].map((it) => it.id);
    ...
    this._transportChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(transportCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
      type: `horizontalBar`,
      data: {
        labels: transports,
    ...
    const timeinCities = events.reduce((acc, event) => {
      ...
      const start = moment__WEBPACK_IMPORTED_MODULE_4___default()(event.start);
      const end = moment__WEBPACK_IMPORTED_MODULE_4___default()(event.end);
    ...
    this._timeSpendChart = new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(timeCtx, {
      plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
      type: `horizontalBar`,
      data: {
        labels: cities,
...
class TripInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _getDate() {
    ...
    this._dateStartTrip = moment__WEBPACK_IMPORTED_MODULE_1___default()(this._eventsData[0].start).format(`MMM DD`);
    this._dateEndTrip = moment__WEBPACK_IMPORTED_MODULE_1___default()(this._eventsData[this._eventsData.length - 1].end).format(`MMM DD`);
  }
...
/* harmony import */ var _components_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../components/event.js */ "./src/components/event.js");
...
class EventController {
  constructor(eventData, mode, container, onDataChange, onChangeView) {
    ...
    this._event = new _components_event_js__WEBPACK_IMPORTED_MODULE_0__["default"](eventData);
    this._eventEdit = new _components_event_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](eventData);
  ...
  create(mode) {
    ...
    let position = _util_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND;
    if (mode === _util_js__WEBPACK_IMPORTED_MODULE_2__["ModeType"].ADD) {
      currentView = this._eventEdit.getElement().querySelector(`form`);
      position = _util_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTER;
    ...
    if (mode === _util_js__WEBPACK_IMPORTED_MODULE_2__["ModeType"].DEFAULT) {
    ...
    this._eventEdit.getElement().querySelector(`.event__reset-btn`).addEventListener(`click`, (evt) => {
      ...
      if (mode === _util_js__WEBPACK_IMPORTED_MODULE_2__["ModeType"].ADD) {
        this._onDataChange();
        Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(currentView);
      } else {
        this._bind(_util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].DELETE);
        this._onDataChange(_util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].DELETE, this._eventData, this.onError.bind(this, _util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].DELETE));
      }
      document.removeEventListener(`keydown`, onEscKeydown);
    });
    ...
    this._eventEdit.getElement().querySelector(`.event--edit`).addEventListener(`submit`, (evt) => {
      ...
      this._eventData.destination = {
        ...
        description: _main_js__WEBPACK_IMPORTED_MODULE_4__["allDestinations"].find((it) => it.city === formData.get(`event-destination`)).description,
        pictures: _main_js__WEBPACK_IMPORTED_MODULE_4__["allDestinations"].find((it) => it.city === formData.get(`event-destination`)).pictures,
      };
      this._eventData.price = +formData.get(`event-price`);
      this._eventData.start = moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-start-time`), `D.MM.YY h:mm`).format();
      this._eventData.end = moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-end-time`), `D.MM.YY h:mm`).format();
      ...
      this._bind(_util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].CHANGE);

      this._onDataChange(mode === _util_js__WEBPACK_IMPORTED_MODULE_2__["ModeType"].ADD ? _util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].CREATE : _util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].CHANGE, this._eventData, this.onError.bind(this, _util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].CHANGE), currentView);
      document.removeEventListener(`keydown`, onEscKeydown);
    });
    Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, currentView, position);
  }
  setDefaultView() {
  ...
  _bind(type) {
    ...
    switch (type) {
      case _util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].DELETE:
        this._resetButton.textContent = `Deleting..`;
        break;
      case _util_js__WEBPACK_IMPORTED_MODULE_2__["ActionType"].CHANGE:
...
/* harmony import */ var _components_days_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../components/days-list.js */ "./src/components/days-list.js");
/* harmony import */ var _components_message_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../components/message.js */ "./src/components/message.js");
...
/* harmony import */ var _event_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./event-controller */ "./src/controllers/event-controller.js");
/* harmony import */ var _components_sort_container__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../components/sort-container */ "./src/components/sort-container.js");
...
class TripController {
  constructor(container, onDataChange) {
    ...
    this._message = new _components_message_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._daysList = new _components_days_list_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._sortOrFilterEventsContainer = new _components_sort_container__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._onDataChange = onDataChange;
    this._subscriptions = [];
  ...
  init(eventsData) {
    if (eventsData && eventsData.length === 0) {
      this._renderMessage();
      Object(_util_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._daysList.getElement());
      return;
    }
    if (eventsData) {
  ...
  createEvent(addButton) {
    const defaultEvent = {
      type: _util_js__WEBPACK_IMPORTED_MODULE_6__["TYPES_OF_EVENT"][9].id,
      destination: ``,
      price: 0,
      start: new Date(),
      end: new Date(),
    ...
    if (this._message.getElement()) {
      Object(_util_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._message.getElement());
      this._sort.getElement().classList.remove(`visually-hidden`);
    }
    this._addButton = addButton;
    const eventsListContainer = this._container.querySelector(`.trip-sort`);
    this._creatingEvent = new _event_controller__WEBPACK_IMPORTED_MODULE_4__["default"](defaultEvent, _util_js__WEBPACK_IMPORTED_MODULE_6__["ModeType"].ADD, eventsListContainer, (...args) => {
  ...
  _renderDaysList(events) {
    ...
    const eventsInDays = Object(_util_js__WEBPACK_IMPORTED_MODULE_6__["getEventsInDays"])(sortedEvents);
  ...
  _renderDay(date, index, daysListElement) {
    const day = new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"](date, index);
  ...
  _renderEvent(eventData, eventsListContainer) {
    const eventController = new _event_controller__WEBPACK_IMPORTED_MODULE_4__["default"](eventData, _util_js__WEBPACK_IMPORTED_MODULE_6__["ModeType"].DEFAULT, eventsListContainer, this._onDataChange, this.onChangeView);
...
/*!*********************!*\
  !*** ./src/main.js ***!
  \*********************/
/*! exports provided: allOffers, allDestinations */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allOffers", function() { return allOffers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allDestinations", function() { return allDestinations; });
...
/* harmony import */ var _components_trip_info_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/trip-info.js */ "./src/components/trip-info.js");
/* harmony import */ var _components_stats_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/stats.js */ "./src/components/stats.js");
/* harmony import */ var _components_loading_message_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/loading-message.js */ "./src/components/loading-message.js");
/* harmony import */ var _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/trip-controller.js */ "./src/controllers/trip-controller.js");
...
/* harmony import */ var _provider_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./provider.js */ "./src/provider.js");
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
  url: URL,
  authorization: AUTORIZATION
});
const store = new _store_js__WEBPACK_IMPORTED_MODULE_7__["default"](Keys, window.localStorage);
const provider = new _provider_js__WEBPACK_IMPORTED_MODULE_8__["default"](api, store);

const onDataChange = (actionType, data, onError, element) => {
  switch (actionType) {
    case _util_js__WEBPACK_IMPORTED_MODULE_9__["ActionType"].DELETE:
      provider.deleteEvent(data.id)
        .then(() => provider.getEvents())
        .then((events) => {
          tripController.init(events);
          tripInfoCost.innerHTML = Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["getPrice"])(events);
          info.remove();
      ...
      break;
    case _util_js__WEBPACK_IMPORTED_MODULE_9__["ActionType"].CHANGE:
      ...
      break;
    case _util_js__WEBPACK_IMPORTED_MODULE_9__["ActionType"].CREATE:
      provider.createEvent(data)
        ...
        .then((events) => {
          ...
          info.remove();
          info = renderInfo(events);
          Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["remove"])(element);
        })
        .catch(() => {
          onError();
        });
...
const renderInfo = (events) => {
  const info = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_2__["default"](events);
  if (events.length !== 0) {
    Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripInfo, info.getElement(), _util_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTERBEGIN);
  }
  return info.getElement();
};
const menu = new _components_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
const filters = new _components_filters_js__WEBPACK_IMPORTED_MODULE_1__["default"](_util_js__WEBPACK_IMPORTED_MODULE_9__["filtersNames"]);
const stats = new _components_stats_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const loadingMessage = new _components_loading_message_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](tripEvents, onDataChange);

Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripControls.querySelector(`h2`), menu.getElement(), _util_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].AFTER);
Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripControls, filters.getElement(), _util_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripEvents, stats.getElement(), _util_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["render"])(tripEvents, loadingMessage.getElement(), _util_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
...
.then(() => {
  Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["remove"])(loadingMessage.getElement());
});
...
/***/ "./src/models/model-destinations.js":
/*!******************************************!*\
  !*** ./src/models/model-destinations.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModelDestinations; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ModelEvent; });
class ModelEvent {
  constructor(data) {
    this.id = data[`id`] || ``;
    this.type = data[`type`];
...
class Provider {
  ...
  getEvents() {
    if (this._isOnline()) {
      return this._api.getEvents()
        .then((events) => {
          events.map((it) => {
            return this._store.setItem(it.id, _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(it));
          });
          return events;
        });
    } else {
      const events = Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["objectToArray"])(this._store.getAll());
      const a = _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents(events);
  ...
  createEvent(newEvent) {
    if (this._isOnline()) {
      return this._api.createEvent(newEvent)
        .then((event) => {
          this._store.setItem(event.id, _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(event));
          return event;
        });
    } else {
      this._store.setItem(this._generateId(), _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(newEvent));
  ...
  changeEvent(id, data) {
    if (this._isOnline()) {
      ...
      this._store.setItem(data.id, _models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].toRAW(data));
      return Promise.resolve(_models_model_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvent(data));
    }
  }
  getOffers() {
    if (this._isOnline()) {
  ...
  syncEvents() {
    return this._api.syncEvents(Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["objectToArray"])(this._store.getAll()));
  }
  _isOnline() {
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: createElement, ActionType, ModeType, RenderPosition, render, remove, getEventsInDays, getPrice, filtersNames, TYPES_OF_TRANSFER, TYPES_OF_ACTIVITY, TYPES_OF_EVENT, objectToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventsInDays", function() { return getEventsInDays; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPrice", function() { return getPrice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filtersNames", function() { return filtersNames; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TYPES_OF_TRANSFER", function() { return TYPES_OF_TRANSFER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TYPES_OF_ACTIVITY", function() { return TYPES_OF_ACTIVITY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TYPES_OF_EVENT", function() { return TYPES_OF_EVENT; });
...
const getEventsInDays = (eventsData) => {
